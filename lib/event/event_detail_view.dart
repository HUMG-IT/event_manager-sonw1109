  ...
  Future<void> _pickDateTime({required bool isStart}) async {
    ...
    if (pickedDate != null) {
      ...
      final pickedTime = await showTimePicker(
        context: context,
        initialTime:
            TimeOfDay.fromDateTime(isStart ? widget.event.startTime : widget.event.endTime),
      );
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  // Chỉ hiển thị nút xóa nếu không có sự kiện mới
                  if (widget.event.id != null)
                    FilledButton.tonalIcon(
                        onPressed: _deleteEvent, label: const Text('Xóa sự kiện')),
